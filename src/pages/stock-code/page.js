...
// //       // Restaurer le remplissage (pas l'opacité)
// //       const fillPath = acElement.querySelector(".ac-fill");
// //       if (fillPath) {
// //         const compClass = Array.from(acElement.classList).find(c => c.startsWith("competence-"));
// //         const color = colorMap[compClass];
        
// //         // Appliquer directement le remplissage sans animation
...
// //         fillPath.style.clipPath = clipPath;
// //       }
...
// // Attacher les événements aux boutons du panneau
// V.attachEvents = function() {
//   const percentBtns = V.pannelView.dom().querySelectorAll(".percent-btn");
...
// // Colorier l'AC selon le pourcentage
// // V.colorizeAC = function(acElement, percent) {
// //   const colorMap = {
// //     "competence-1": "#A30000",
// //     "competence-2": "#FF5500",
// //     "competence-3": "#FFCC00",
...
// //   // Sélectionner SEULEMENT le polygone de remplissage (pas l'icône)
// //   const fillPath = acElement.querySelector(".ac-fill");
  
// //   if (fillPath) {
// //     if (parseInt(percent) > 0) {
// //       // Animer le remplissage progressif
// //       Animation.fillPolygon(fillPath, color, percent);
// //       fillPath.dataset.isSelected = "true";
// //     } else {
// //       // Réinitialiser si 0%
// //       gsap.to(fillPath, {
...
// //         ease: "power2.inOut"
// //       });
// //       fillPath.dataset.isSelected = "false";
// //     }
// //   }
// // };
...
// // Calculer et appliquer le clip-path pour le remplissage (de bas en haut)
// // V.updateFillClipPath = function(fillPath, percent, bbox) {
// //   const percentValue = parseInt(percent);
  
// //   // Remplissage de bas en haut (bottom-up)
...
// //   // Récupérer les dimensions du SVG pour calculer le remplissage
// //   const fillPath = acElement.querySelector(".ac-fill");
// //   if (fillPath) {
// //     const bbox = fillPath.getBBox();
// //     V.updateFillClipPath(fillPath, percent, bbox);
// //   }
  
// //   // Sauvegarder avec historique
// //   Storage.saveAC(acElement.id, percent);
// //   V.updateNiveauxPanel();
  
// //   // Mettre à jour l'historique dans le panneau
// //   if (V.pannelView.currentAcId === acElement.id) {
// //     V.pannelView.displayHistory(acElement.id);
// //   }
// // };
...
// //   const path = acElement.querySelector("path[opacity]");
// //   if (path) {
// //     path.setAttribute("data-fill-percent", percent);
...
//   // Mettre à jour l'historique dans le panneau
//  if (V.pannelView.historiqueView && V.pannelView.currentAcId === acElement.id) {
//   V.pannelView.historiqueView.display(acElement.id, V.pannelView.currentCompetence);
// }
// };
